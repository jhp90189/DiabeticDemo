//
//  KZSegmentedControl.swift
//  Segment

import UIKit

@IBDesignable
open class KZSegmentedControl: UIView {
    ...
    @IBInspectable open var containerBackgroundColor: UIColor = KZSegmentedControl.UIColorFromRGB(0xF4F4F4)
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [KZSegmentedControl.UIColorFromRGB(0xFFE900),KZSegmentedControl.UIColorFromRGB(0xFFB400)]
    @IBInspectable open var thumbShadowColor: UIColor = KZSegmentedControl.UIColorFromRGB(0x9B9B9B)
    ...
    fileprivate let thumbPadding: CGFloat = 3//2
